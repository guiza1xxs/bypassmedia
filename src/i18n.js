...
const resources = {
  en: {
    translation: {
      ...
      p2_desc: "Conversion architectures tested on over €50M in ad spend across restricted niches.",
  ...
  pt: {
    translation: {
      ...
      p2_desc: "Arquiteturas de conversão testadas em mais de €50M em investimento publicitário em nichos restritos.",
